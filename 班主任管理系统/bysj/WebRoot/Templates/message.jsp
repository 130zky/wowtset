...
%>
  ...
  <% }
       ...
       <%if (showPage>1){%>
       <a href="message.jsp?page=1">[第一页]</a>&nbsp;<a href="message.jsp?page=<%=showPage-1%>">[上一页]</a>
       <%}else{%>
        [第一页]&nbsp;[上一页]
        <%}
         if (showPage< pageCount) {%>
         &nbsp;<a href="message.jsp?page=<%=showPage+1%>">[下一页]</a>&nbsp;<a href="message.jsp?page=<%=pageCount%>">[最后页]</a>
         <%}else{%>
         &nbsp;[下一页]&nbsp;[最后页]
         <%}%></div>
 <%if (session.getAttribute("islog")!=null){%>
      <form name="form2" method="post" action="../servlet?action=message">
        <table width="560" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td><input type="reset" name="Submit4" value="重置"></td>
            <td>&nbsp;</td>
          </tr>
        </table>
      </form>
    ...
    <td height="302" valign="top"  ><table width="100" height="323" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="222" height="302"><table width="222" height="323" border="0" cellpadding="0" cellspacing="0" bgcolor="#ECECEC">
              <tr>
                <td   ><div align="center" class="a01"><a href="student.jsp" class="a01">学生基本信息管理</a></div></td>
              </tr>
              <tr>
  ...
  <tr >
    <td height="112" colspan="4" class="shixian"><p align="center">Copyright ?2006 All Rights Reserved<br />
        毕业设计工作组 版权所有 邮箱:biyesheji@163.com <br />
      </p>
