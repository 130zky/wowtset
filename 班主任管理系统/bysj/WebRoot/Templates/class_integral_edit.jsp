...
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
  ...
  try{
    ...
    String condition="select * from scoreinfo where jtime='"+jtime+"'";
    int i = dbutil.execQueryName(condition);
    if(i>0){
      HashMap hm  = (HashMap)(dbutil.getRS().get(0));
      id=(String)hm.get("id");
      wsjf=(String)hm.get("wsjf");
      jljf=(String)hm.get("jljf");
      cqjf=(String)hm.get("cqjf");
      otherjf=(String)hm.get("otherjf");
      recorder=(String)hm.get("recorder");
      recorderid=(String)hm.get("recorderid");
    }
  }
...
<td colspan="2" valign="top" bgcolor="#FFFFFF"  ><!-- InstanceBeginEditable name="栏目" -->
  ...
  <!-- InstanceEndEditable --></td>
    ...
    <tr>
      <td height="176" valign="top"  >					<form id="form" name="form" method="post" action="../servlet?action=login" onsubmit="return check(this);">
...
<td><input type="text" name="wsjf" value="<%=wsjf%>"></td>
  <td><div align="left">纪律：

</div></td>
<td><input type="text" name="jljf" value="<%=jljf%>"></td>
    </tr>
    <tr class="css1">
      <td>出勤：</td>
      <td><input type="text" name="cqjf" value="<%=cqjf%>"></td>
        <td>其他积分：</td>
        <td><input type="text" name="otherjf" value="<%=otherjf%>"></td>
    </tr>
    <tr class="css1">
      <td><div align="left">记录人姓名：

</div></td>
<td><input type="text" name="recorder" value="<%=recorder%>"></td>
  <td><div align="left">记录人编号：

</div></td>
<td><input type="text" name="recorderid" value="<%=recorderid%>"></td>
    </tr>
    <tr class="css1">
    ...
    <tr class="css1">
      <td colspan="4"><div align="center">
        <input name="edit" type="submit" id="edit" value="修改">
      </div></td>
      </tr>
  </table>
  </form>
