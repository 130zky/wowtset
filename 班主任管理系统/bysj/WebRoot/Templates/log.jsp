  ...
  <%
   ...
   java.sql.Statement sql = null;
    ...
    try {
     ...
     String condition = "SELECT * FROM rzgl order by rno desc";
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr  >
    ...
    <td colspan="2" valign="top" bgcolor="#FFFFFF"  ><!-- InstanceBeginEditable name="栏目" -->
      <div align="center" class="css1">日 志 管 理</div>
  ...
  <tr>
    ...
    <td width="557" rowspan="2" valign="top" bgcolor="#FFFFFF" ><!-- InstanceBeginEditable name="内容" -->
      <table width="560" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td class="css1"><div align="center">姓名</div></td>
          <td class="css1"><div align="center">登入时间</div></td>
          <td class="css1"><div align="center">登出时间</div></td>
        </tr>
              <%
   ...
   for(int i=1;i<=pageSize;i++) {
     %>
        <tr>
          <td class="css1"><div align="center"><%out.print(""+rs.getString("rno"));%></div></td>
          <td class="css1"><div align="center"><%out.print(""+rs.getString("rname"));%></div></td>
          <td class="css1"><div align="center"><%out.print(""+rs.getString("intime"));%></div></td>
          <td class="css1"><div align="center"><%out.print(""+rs.getString("outtime"));%></div></td>
        </tr>
             <%
    boolean beal;
    beal=rs.next();
  ...
  <% }
       ...
       <%if (showPage>1){%>
       <a href="log.jsp?page=1">[第一页]</a>&nbsp;<a href="log.jsp?page=<%=showPage-1%>">[上一页]</a>
       <%}else{%>
        [第一页]&nbsp;[上一页]
        <%}
         if (showPage< pageCount) {%>
         &nbsp;<a href="log.jsp?page=<%=showPage+1%>">[下一页]</a>&nbsp;<a href="log.jsp?page=<%=pageCount%>">[最后页]</a>
         <%}else{%>
         &nbsp;[下一页]&nbsp;[最后页]
         <%}%></div>
    <!-- InstanceEndEditable --> </td>
